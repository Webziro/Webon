...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/logo-and-branding.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:15 GMT -->
<head>
...
<body class="body-bg-style-2 inner-page">
    <div class="page-wrapper">
        ...
        <svg class="bg-shape inner-page-shape-banner-left reveal-from-left" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <path fill-rule="evenodd" fill="url(#PSgrad_07)" d="M111.652,578.171 L218.141,672.919 C355.910,795.500 568.207,784.561 692.320,648.484 C816.434,512.409 805.362,302.726 667.592,180.144 L561.104,85.396 C423.334,-37.184 211.037,-26.245 86.924,109.832 C-37.189,245.908 -26.118,455.590 111.652,578.171 Z"
            />
        </svg>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-opener active" href="#">
                                Services
                            </a>
                            <div class="custom-dropdown-menu">
                                <a class="dropdown-item" href="website-design.html">Website Design</a>
                                <a class="dropdown-item active" href="logo-and-branding.html">Logo &amp; Branding</a>
            ...
            <div class="container">
                <div class="row align-items-center image-with-description-block">
                    ...
                    <div class="col-lg-6 text-lg-right">
                        <img src="images/services/logo-and-branding.jpg" alt="web design description image" class="img-fluid">
                    </div>
                    <!-- End of .col-lg-6 -->
                </div>
                <!-- End of .row -->
    ...
    ======================================= -->
        <section class="our-process section-padding">
            <div class="container">
                ...
                <p class="section-subheading text-center">Great websites add great values to your business. From wire-framing to
                ...
                <div class="service-process-tab">
                    <ul class="nav nav-tabs service-tab-nav" id="service-tab-nav" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="process-nav-1" data-bs-toggle="tab" href="#process-tab-1" role="tab" aria-controls="process-tab-1"
                                aria-selected="true">
                                <i class="ml-des-21-Transform-shape-graphics-design-tool-interface-layers-tool-bar"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="process-nav-2" data-bs-toggle="tab" href="#process-tab-2" role="tab" aria-controls="process-tab-2" aria-selected="true">
                                <i class="ml-des-62-Precision-compasses-graphics-design-tool-interface"></i>
                                <span>Sketches</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="process-nav-3" data-bs-toggle="tab" href="#process-tab-3" role="tab" aria-controls="process-tab-3" aria-selected="true">
                                <i class="ml-des-35-divide-unite-intersect-exclude-graphics-design-tool-interface"></i>
                                <span>Digitization</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="process-nav-4" data-bs-toggle="tab" href="#process-tab-4" role="tab" aria-controls="process-tab-4" aria-selected="true">
                                <i class="ml-des-49-color-picker-paint-graphics-design-tool-interface"></i>
                                <span>Color</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="process-nav-5" data-bs-toggle="tab" href="#process-tab-5" role="tab" aria-controls="process-tab-5" aria-selected="true">
                    ...
                    <div class="tab-content service-tab-content" id="service-tab">
                        <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-1.jpg" alt="Process image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                                ...
                                <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                                        tincid unt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam.</p>
                                    <p>Quis nostrud exerci tation ullam corper suscipit lobortis nisl ut aliquip ex ea commodo
                                        consequat. </p>
                        ...
                        <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-2.jpg" alt="Process image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-3.jpg" alt="Process image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-4" role="tabpanel" aria-labelledby="process-nav-4">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-4.jpg" alt="Process image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-5" role="tabpanel" aria-labelledby="process-nav-5">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-5.jpg" alt="Process image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
    ...
    ======================================= -->
        <section class="featured-projects section-padding">
            ...
            <div class="container">
                <h2 class="text-center">Featured Designs</h2>
...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/logo-and-branding.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:19 GMT -->
</html>