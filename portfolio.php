...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:52 GMT -->
<head>
                    ...
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        <li class="nav-item dropdown">
                            ...
                            <div class="custom-dropdown-menu">
                                ...
                                <a class="dropdown-item" href="search-engine-optimization.html">Search Engine
                                    Optimization</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link custom-btn btn-mid grad-style-cd" href="contact.html" data-bs-toggle="modal"
                                data-bs-target="#get-a-quote-modal">GET A QUOTE</a>
                        </li>
                    </ul>
                    <!-- End of .navbar-nav -->
                </div>
            ...
            <div class="container">
                ...
                <div class="project-showcase text-center">
                    <div class="filter-button-group">
                        ...
                        <a href="javascript:void(0)" class="filter-button" data-filter=".a4">Social Media</a>
                    </div>
                    ...
                    <div class="grid row equalHeightWrapper">
                        ...
                        <div class="a1 a4 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block video-popup" data-bs-toggle="modal"
                                data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-1.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                        ...
                        <div class="a1 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-2.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                        ...
                        <!-- End of .grid-item -->
                        <div class="a2 a4 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-3.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                        ...
                        <div class="a3 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-4.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                        ...
                        <div class="a3 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-5.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                        ...
                        <div class="a3 grid-item col-md-6 col-lg-4">
                            <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                                <div class="img-container">
                                    <img src="images/featured-projects/featured-project-6.jpg" alt="Project image"
                                        class="img-fluid">
                                </div>
                                <!-- End of .img-container -->
                                <h5 class="equalHeight">
                            ...
                            <div id="featured-project-carousel" class="carousel slide featured-project-carousel"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100 img-fluid" src="images/featured-projects/modal-img-1.jpg"
                                            alt="First slide">
                                    </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:53 GMT -->
</html>