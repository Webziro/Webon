            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link custom-btn btn-mid grad-style-cd" href="contact.php" data-bs-toggle="modal" data-bs-target="#get-a-quote-modal">GET A QUOTE</a>
                        </li>
                    </ul>
                    <!-- End of .navbar-nav -->
                </div>
                        ...
                        <div class="col-md-3">
                            <nav class="footer-nav">
                                ...
                                <ul class="footer-menu">
                                    <li>
                                        <a href="logo-and-branding.php">Logo &amp; Branding</a>
                                    </li>
                                    <li>
