...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/search-engine-optimization.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:20 GMT -->
<head>
                    ...
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        <li class="nav-item dropdown">
                            ...
                            <div class="custom-dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="search-engine-optimization.html">Search Engine Optimization</a>
                ...
                <div class="service-process-tab">
                    ...
                    <div class="tab-content service-tab-content" id="service-tab">
                        <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/seo-process/seo-process-img-1.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/seo-process/seo-process-img-2.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/seo-process/seo-process-img-3.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-4" role="tabpanel" aria-labelledby="process-nav-4">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/seo-process/seo-process-img-4.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-5" role="tabpanel" aria-labelledby="process-nav-5">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/seo-process/seo-process-img-5.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/search-engine-optimization.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:22 GMT -->
</html>