...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/pay-per-click.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:22 GMT -->
<head>
...
<body class="body-bg-style-2 inner-page">
                    ...
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        <li class="nav-item dropdown">
                            ...
                            <div class="custom-dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="pay-per-click.html">Pay-Per-Click</a>
    ...
    ======================================= -->
        <div class="inner-page-banner">
            <div class="container text-center">
                <h1>Pay-Per-Click</h1>
                <p>Driving more traffic to your website by increasing rank in different search engines.</p>
            </div>
            <!-- End of .container -->
        </div>
        <!-- End of .banner -->
    ...
    ======================================= -->
        <section class="image-with-description">
            <svg class="bg-shape image-with-description-shape-bg reveal-from-left" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                width="779px" height="759px">
                <defs>
            ...
            <div class="container">
                <div class="row align-items-center image-with-description-block">
                    ...
                    <div class="col-lg-6 text-lg-right">
                        <img src="images/services/pay-per-click.jpg" alt="service description image" class="img-fluid">
                    </div>
                    <!-- End of .col-lg-6 -->
                </div>
                <!-- End of .row -->
                ...
                <div class="service-process-tab">
                    ...
                    <div class="tab-content service-tab-content" id="service-tab">
                        <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/ppc-process/ppc-process-img-1.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/ppc-process/ppc-process-img-2.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/ppc-process/ppc-process-img-3.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-4" role="tabpanel" aria-labelledby="process-nav-4">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/ppc-process/ppc-process-img-4.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
                        ...
                        <div class="tab-pane fade" id="process-tab-5" role="tabpanel" aria-labelledby="process-nav-5">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-5 text-lg-right">
                                    <img src="images/services/process-tab/ppc-process/ppc-process-img-5.jpg" alt="Process image" class="img-fluid">
                                </div>
                                <!-- End of .col-lg-6 -->
        ...
        <section class="inner-page-case-studies section-padding">
            ...
            <div class="container">
                ...
                <div class="case-study-showcase text-center">
                    ...
                    <!-- End of .grid -->
                    <a href="case-studies.html" class="custom-btn btn-big grad-style-ef btn-full">DISCOVER MORE CASE STUDIES</a>
                </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/pay-per-click.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:24 GMT -->
</html>