...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/mobile-app-development.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:19 GMT -->
<head>
                    ...
                    <ul class="navbar-nav ml-md-auto typo-color-c align-items-center">
                        <li class="nav-item dropdown">
                            ...
                            <div class="custom-dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="mobile-app-development.html">Mobile App Design</a>
    ...
    ======================================= -->
        <div class="inner-page-banner">
            <div class="container text-center">
                ...
                <p>We’ll create web or mobile applications specifically for your company.</p>
            </div>
            <!-- End of .container -->
        </div>
        <!-- End of .banner -->
            ...
            <div class="container">
                <div class="row align-items-center image-with-description-block">
                    ...
                    <div class="col-lg-6 text-lg-right">
                        <img src="images/services/app-development.jpg" alt="web design description image" class="img-fluid">
                    </div>
                    <!-- End of .col-lg-6 -->
                </div>
                <!-- End of .row -->
...
<!-- Mirrored from new.axilthemes.com/demo/template/cynic-bs5/trendy-small-digital-agency/mobile-app-development.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Aug 2025 21:39:20 GMT -->
</html>